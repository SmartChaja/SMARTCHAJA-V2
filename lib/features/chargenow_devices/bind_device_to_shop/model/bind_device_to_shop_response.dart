class BindDeviceToShopResponse {
  final String msg;
  ...
  BindDeviceToShopResponse({
    required this.msg,
    required this.code,
    this.data,
  });

  factory BindDeviceToShopResponse.fromJson(Map<String, dynamic> json) {
    return BindDeviceToShopResponse(
